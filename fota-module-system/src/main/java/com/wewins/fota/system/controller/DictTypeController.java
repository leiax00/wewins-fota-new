...
public class DictTypeController {
    ...
    public DictTypeController(IDictTypeService dictTypeService, IDictItemService dictItemService) {
     ...
     */
    @GetMapping
    public Response<PageResponse<DictType>> listDictTypes(@ModelAttribute DictTypePageReqVO reqVO) {
        if (reqVO == null) {
