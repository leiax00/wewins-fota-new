package com.wewins.fota.module.system.adapter.api.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleAuthenticationException(AuthenticationException e) {
        ...
        if (e instanceof BadCredentialsException) {
            return ResponseEntity
                    ...
                    .body(ApiResponse.error(ErrorCode.USERNAME_PASSWORD_ERROR.getCode(),
                            ErrorCode.USERNAME_PASSWORD_ERROR.getMessage()));
        } else if (e instanceof DisabledException) {
            return ResponseEntity
                    .status(HttpStatus.UNAUTHORIZED)
                    .body(ApiResponse.error(ErrorCode.ACCOUNT_DISABLED.getCode(),
    ...
    public ResponseEntity<ApiResponse<Object>> handleTokenExpiredException(TokenExpiredException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.UNAUTHORIZED)
                .body(ApiResponse.error(ErrorCode.TOKEN_EXPIRED.getCode(),
