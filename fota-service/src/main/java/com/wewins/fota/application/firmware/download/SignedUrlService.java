 ...
 * </p>
 * <ul>
 *   <li>溯源：记录 policy_id、request_id、timestamp</li>
...
public interface SignedUrlService {
     ...
     * @return 签名下载 URL
     */
    String generateSignedUrl(String firmwarePath, Long policyId, String requestId);
     ...
     * @return 签名下载 URL
     */
    String generateSignedUrl(String firmwarePath, Long policyId, String requestId, int expireSeconds);
     ...
     */
    boolean verifySignature(String firmwarePath, Long policyId, String requestId, long expireTime, String signature);
}
